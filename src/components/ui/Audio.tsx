...
export default function Audio() {
  ...
  return (
    <>
      ...
      <button
          onClick={toggleMute}
          className="fixed bottom-6 right-6 z-50 w-12 h-12 rounded-full bg-gray-500  border border-white/50 flex items-center justify-center hover:bg-white/20 transition-all duration-300 shadow-lg"

...
export default function TimelineCard({ 
  ...
  return (
    ...
    >
      ...
      <div className={`text-[16px] sm:text-2xl md:text-3xl lg:text-4xl text-white [text-shadow:0px_4px_0px_rgb(0_0_0/1.00)] wrap-break-word overflow-wrap-anywhere w-full ${headingClassName}`}>
        {cardHeading}
      </div>

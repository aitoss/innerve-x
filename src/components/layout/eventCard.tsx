  ...
  return (
    <>
      <div className="relative">
        <PlankImage />
        <div className="absolute top-1/5 left-1.5 sm:left-2 md:left-3 lg:left-[-20px] z-50">
          <EventCardShield />
        </div>
        ...
        <div className="absolute">
          ...
          <div className="absolute text-stroke-h2 -top-[105px] left-[116px] sm:-top-[150px] sm:left-[165px] md:-top-[210px] md:left-[231px] lg:-top-[300px] lg:left-[300px] text-white text-center text-[8px] sm:text-[12px] md:text-[17px] lg:text-[24px] font-bold [text-shadow:0px_1.8px_0px_rgb(0_0_0/1.00)] sm:[text-shadow:0px_2.5px_0px_rgb(0_0_0/1.00)] md:[text-shadow:0px_3.5px_0px_rgb(0_0_0/1.00)] lg:[text-shadow:0px_5px_0px_rgb(0_0_0/1.00)] flex gap-1 sm:gap-1.5 md:gap-2 lg:gap-3 justify-center">
